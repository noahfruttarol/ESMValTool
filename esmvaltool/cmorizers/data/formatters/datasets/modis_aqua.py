"""ESMValTool CMORizer for MODIS aqua data.
...
Modification history
    20260216-Fruttarol_Noah: Written based on the original MODIS CMORization NCL script created by evaldsson_martin, which can be found in at ESMValTool/esmvaltool/cmorizers/data/formatters/datasets/_modis_aqua.ncl
...
def collect_files(in_dir: str, cfg) -> list:
    ...
    fname_pattern = (
        f"{attrs['version']}\\.A.*\\.hdf$"  # e.g. "MYD08_M3.A*.hdf"
    )
